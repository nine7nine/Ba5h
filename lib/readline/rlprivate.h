...
extern void _rl_syntax_color_on (int);
extern void _rl_syntax_color_off (int);
extern int _rl_reset_syntax_color (int, int, const char *);
...
extern int _rl_enable_syntax_highlighting;
